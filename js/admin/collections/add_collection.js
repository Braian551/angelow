// add_collection.js - Agregar colección
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                ...
                showToast(data.message || 'Error al guardar la colección', 'error');
                submitBtn.disabled = false;
                submitBtn.innerHTML = '<i class="fas fa-save"></i> Guardar Colección';
            }
        })
        .catch(error => {
