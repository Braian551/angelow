<?php
/**
 * Script para poblar la base de datos con notificaciones de prueba
...
try {
    ...
    $stmt = $pdo->query("SELECT id FROM usuarios WHERE role IN ('user', 'customer') LIMIT 1");
    ...
    echo "\n";
    echo "Accede a: " . BASE_URL . "/users/notifications.php\n";
