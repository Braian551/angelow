...
VALUES (
        ...
        'root@localhost',
        '2025-08-20 02:37:44',
        'Se creó la orden #TEST001 con total $0.00'
    );
...
VALUES (
        ...
        'root@localhost',
        '2025-08-20 02:53:23',
        'Se creó el usuario: Usuario Prueba (prueba@ejemplo.com). Rol: customer'
    ),
    (
        2,
        'TEST_USER_001',
        ...
        'root@localhost',
        '2025-08-20 02:53:23',
        'Usuario actualizado. Cambios: Nombre: Usuario Prueba → Usuario Modificado. Rol: customer → admin. '
    ),
    (
        3,
        'TEST_USER_001',
        ...
        'root@localhost',
        '2025-08-20 02:53:24',
        'Se eliminó el usuario: Usuario Modificado (prueba@ejemplo.com). Rol: admin'
    );
...
VALUES (
        ...
        'Vestidos',
        'vestidos',
        'Vestidos infantiles para ocasiones especiales',
        NULL,
        NULL,
        1,
        '2025-06-21 21:11:42',
    ...
    (
        ...
        'Accesorios',
        'accesorios',
        'Complementos y accesorios infantiles',
        NULL,
        NULL,
        1,
        '2025-06-21 21:11:42',
    ...
    (
        ...
        'Ropa Casual',
        'ropa-casual',
        'Ropa informal para el día a día',
        NULL,
        NULL,
        1,
        '2025-06-21 21:11:42',
...
/*!50003 TRIGGER `trg_categories_insert` AFTER INSERT ON `categories` FOR EACH ROW INSERT INTO audit_categories(category_id, action_type, new_name)
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `trg_categories_update` AFTER UPDATE ON `categories` FOR EACH ROW INSERT INTO audit_categories(category_id, action_type, old_name, new_name)
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `trg_categories_delete` AFTER DELETE ON `categories` FOR EACH ROW INSERT INTO audit_categories(category_id, action_type, old_name)
...
VALUES (
        ...
        'Verano Mágico',
        'verano-magico',
        'Colección de verano con colores vibrantes y diseños frescos',
        NULL,
        '2025-05-01',
        1,
        '2025-06-29 00:15:58',
    ...
    (
        ...
        'Aventura Infantil',
        'aventura-infantil',
        'Ropa cómoda y resistente para pequeños exploradores',
        NULL,
        '2025-04-15',
        1,
        '2025-06-29 00:15:58',
    ...
    (
        ...
        'Dulces Sueños',
        'dulces-suenos',
        'Pijamas y ropa de dormir ultra suaves',
        NULL,
        '2025-03-20',
        1,
        '2025-06-29 00:15:58',
    ...
    (
        ...
        'Colección Clásica',
        'coleccion-clasica',
        'Diseños atemporales para ocasiones especiales',
        NULL,
        '2025-01-10',
        1,
        '2025-06-29 00:15:58',
    ...
    (
        ...
        'Mini Trendsetters',
        'mini-trendsetters',
        'Las últimas tendencias en moda infantil',
        NULL,
        '2025-06-01',
        1,
        '2025-06-29 00:15:58',
...
VALUES (
        4,
        '6860007924a6a',
        '100021586628962750893',
        'ya29.a0AS3H6NxWuxsKzvVZ78hlXIpNbkEuyBhlqCM-TAZVUOGequUWV3a07XgX6zOV1CBF5qW5qfR_7FaFucKHLluMZBfjTZw_MhKSVmbokJERwtzQbROc1a4BocIWIQ0ZL_W40z-KWYjh0I9SLbEtH3W2B_XqUlIn12l0fHRav4jESwaCgYKAZwSARESFQHGX2MihiMSealW_Ok6ItYSjWrP7Q0177',
        '2025-07-09 18:18:26'
    );
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `auditoria_orden_insert` AFTER INSERT ON `orders` FOR EACH ROW BEGIN
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `auditoria_orden_update` AFTER UPDATE ON `orders` FOR EACH ROW BEGIN
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `auditoria_orden_delete` BEFORE DELETE ON `orders` FOR EACH ROW BEGIN
INSERT INTO audit_orders (orden_id, accion, usuario_id, sql_usuario, detalles)
VALUES (
OLD.id, 
'DELETE', 
...
VALUES (
        ...
        'ahorros',
        'Braian Oquendo',
        'uploads/payment_proofs/6863680e6fd16_braian-caricatura.jpg',
        'adjfufdcusadhfi',
        '2025-06-30 23:46:06',
        '2025-06-30 23:46:06'
    );
...
VALUES (
        ...
        61,
        NULL,
        'uploads/productos/687d07be0095b_deportivo.jpg',
        'Ropa deportiva - Imagen principal',
        0,
        '2025-07-20 10:14:06',
        1
    );
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `tr_insert_producto` BEFORE INSERT ON `productos_auditoria` FOR EACH ROW BEGIN
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `tr_update_producto` BEFORE UPDATE ON `productos_auditoria` FOR EACH ROW BEGIN
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `tr_delete_producto` BEFORE DELETE ON `productos_auditoria` FOR EACH ROW BEGIN
...
CREATE TABLE `products` (
    ...
    `gender` enum(
        ...
        'bebe',
        'unisex'
    ) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'unisex',
...
VALUES (
        ...
        'Ropa deportiva',
        'ropa-deportiva',
        '¡Comodidad, estilo y libertad de movimiento!\r\nEste conjunto deportivo de la Colección Clásica de Angelow es ideal para los pequeños que no paran. Fabricado en 100% algodón, ofrece frescura y suavidad, cuidando la piel de tu hijo durante todo el día.',
        'angelow',
        'niño',
        NULL,
        '100% algodon',
        'Para conservar la calidad y durabilidad de esta prenda, se recomienda lavarla a máquina con agua fría y colores similares. No usar blanqueador, ya que puede dañar las fibras del algodón. Secar a baja temperatura o al aire libre para evitar el encogimiento. Si es necesario, planchar a temperatura media. No lavar en seco.',
        NULL,
        35000.00,
        4,
        4,
...
INSERT INTO
    `sessions`
VALUES (
        'S7Q6FdzNOJz68rB8xyis0eOG9cOG9OxHszxndIjm',
        NULL,
        '::1',
        'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36',
        '',
        1755574461
    );
...
CREATE TABLE `user_addresses` (
    ...
    `address_type` enum(
        ...
        'oficina',
        'otro'
    ) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'casa',
...
VALUES (
        ...
        'cc',
        NULL,
        '$2y$10$safkUgrODd3iixhDIq/y9eG7RnlUq.I3MAq3OsG4PXOsT7bZoss76',
        NULL,
        'admin',
        0,
        '2025-06-28 09:47:21',
    ...
    (
        '6861e06ddcf49',
        'Braian',
        'braianoquendurango@gmail.com',
        '3013636902',
        'cc',
        '1023526011',
        '$2y$10$K5B1CBsezIVKb2osCQrgEuTwIr.JMvG2EVPUYZqIhS9yzuboS8prq',
        NULL,
        'customer',
        0,
        '2025-06-29 19:55:10',
    ...
    (
        '6862b7448112f',
        'Juan',
        'braianoquen2@gmail.com',
        NULL,
        'cc',
        NULL,
        '$2y$10$lIkReeDLfMBHL7Mj2Vqrk.0LhoLlVboNNliNulgXzEiIrrexwMtrS',
        NULL,
        'delivery',
        0,
        '2025-06-30 11:11:48',
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `auditoria_usuario_insert` AFTER INSERT ON `users` FOR EACH ROW BEGIN
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `auditoria_usuario_update` AFTER UPDATE ON `users` FOR EACH ROW BEGIN
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `auditoria_usuario_delete` BEFORE DELETE ON `users` FOR EACH ROW BEGIN
INSERT INTO audit_users (usuario_id, accion, usuario_modificador, sql_usuario, detalles)
VALUES (
OLD.id, 
'DELETE', 
...
VALUES (
        ...
        9,
        61,
        'uploads/productos/687d07be0106c_conjunto_niño2.jpg',
        'Ropa deportiva - Imagen 1',
        0,
        1,
        '2025-07-20 10:14:06'
    ),
    (
        ...
        9,
        61,
        'uploads/productos/687d07be015ec_deportivo.jpg',
        'Ropa deportiva - Imagen 2',
        1,
        0,
        '2025-07-20 10:14:06'
    ),
    (
        ...
        10,
        61,
        'uploads/productos/687d07be2aff9_coleccion primavera.jpg',
        'Ropa deportiva - Imagen 1',
        0,
        1,
        '2025-07-20 10:14:06'
    ...
    (
        ...
        10,
        61,
        'uploads/productos/687d07be3da3f_conjunto_niño.jpg',
        'Ropa deportiva - Imagen 2',
        1,
        0,
        '2025-07-20 10:14:06'
    ...
    (
        ...
        10,
        61,
        'uploads/productos/687d07be3e4d3_deportivo2.jpg',
        'Ropa deportiva - Imagen 3',
        2,
        0,
        '2025-07-20 10:14:06'
    ),
    (
        ...
        10,
        61,
        'uploads/productos/687d07be3ef1c_simba.jpg',
        'Ropa deportiva - Imagen 4',
        3,
        0,
        '2025-07-20 10:14:06'
    );
